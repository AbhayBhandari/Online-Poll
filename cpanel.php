...
<html lang="en">
  ...
  <div class="container">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
             ...
             <li><a href="nomination.html"><span class="subFont">Candidates</span></a></li>
            <li><a href="changePassword.php"><span class="subFont">Change Password</span></a></li>
            <li><a href="allFeedBackAdminPanel.php"><span class="subFont">Feedback Reports</span></a></li> 
            <li><a href="allVoters.php"><span class="subFont">All Voters</span></a></li> 
          </ul>
          
          <span class="normalFont"><a href="index.html" class="btn btn-success navbar-right navbar-btn">Logout</a></span></button>
        </div>
    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        <div class="col-sm-12" style="border:8px solid #e7d800;">
          
          <div class="page-header">
            <h1 class="specialHead">Result</h1>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Bharatiya Janata Party &nbsp;&nbsp;($BJP Votes)</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Indian National Congress &nbsp;&nbsp;($INC Votes)</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Aam Aadmi Party &nbsp;&nbsp;($AAP Votes)</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Trinamool Congress &nbsp;&nbsp;($TMC Votes)</strong><br>";
                  echo "
                  <div class='progress'>
               ...
               echo "<hr>";
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  <div class='text-primary'>
                    <br>
                    <h3 class='normalFont text-center'>TOTAL VOTES : $total </h3>
                  </div>
                  ";
                }
