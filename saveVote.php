    ...
    <div class="container" style="padding-top:150px;">
       ...
       or die("Couldn't Connect to Database :");
				...
				if(mysqli_query($conn, $sql)){
					...
					echo "<h3 class='text-info specialHead text-center'> YOU HAVE  SUCCESSFULLY  VOTED.</h3>";
				...
				else
				{
					...
					echo "<h3 class='text-info specialHead text-center'> SORRY! THERE IS SOME ISSUE.</h3>";
					echo "<a href='index.html' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> Home </a>";
				}
        mysqli_close($conn);
				?>
